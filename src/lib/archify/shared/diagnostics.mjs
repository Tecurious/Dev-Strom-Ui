...
const DIAGNOSTIC_MODE = false; // browser vendor: no env
const recorded = [];
...
function fallbackDiagnostic(error) {
  const input = undefined; // browser vendor: no CLI argv
...
export function installRendererDiagnosticBoundary() { /* browser vendor: no-op */ }
